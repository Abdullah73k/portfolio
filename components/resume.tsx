	...
	return (
		<div className="bg-background mx-auto w-full max-w-3xl px-6 py-12 sm:px-8 md:py-16">
			...
			<header className="mb-10">
				...
				<div className="mt-4 flex flex-wrap items-center gap-3">
					<Button
						...
						size="sm"
						render={(props) => (
							<a {...props} href={`mailto:${personal.email}`} />
						)}
					>
						<HugeiconsIcon
							icon={MailIcon}
					...
					<Button
						variant="ghost"
						size="sm"
						render={(props) => <a {...props} href={`tel:${personal.phone}`} />}
					>
						<HugeiconsIcon
			...
			<footer className="flex justify-center pb-8">
				...
				>
					<a
						href="https://mac-csse-webring.vercel.app/#abdullah-khamis-portfolio.vercel.app?nav=prev"
					...
					<a
						href="https://mac-csse-webring.vercel.app/"
						style={{ lineHeight: 0 }}
						title="McMaster CS & SE Webring"
					>
						<img
							src="https://mac-csse-webring.vercel.app/assets/Uni_mcmaster_logo.svg.png"
							alt="McMaster CS & SE Webring"
							style={{ height: 24, width: "auto", display: "block" }}
						/>
					</a>
					<a
						href="https://mac-csse-webring.vercel.app/#abdullah-khamis-portfolio.vercel.app?nav=next"
						className="text-foreground"
						style={{ textDecoration: "none" }}
						title="Next site"
					>
